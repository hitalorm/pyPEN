...
def graph_SDD():
    ...
    plt.title( 'Dose total = '+ str("{0:.3f}".format(integra)) + '$\pm$' + str("{0:.3f}".format(err)) + ' (eV/g/hist)')
...
def graph_track():
    ...
    for i in range(3):
        ...
        ax.set_ylabel('y (cm)', fontsize = 18,labelpad=10)
